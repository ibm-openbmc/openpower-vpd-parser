...
class Manager
{
  public:
     ...
     */
    std::string
        getExpandedLocationCode(const std::string& i_unexpandedLocationCode,
                                uint16_t i_nodeNumber = 0);
    ...
    /**
     * @brief Get D-Bus object path of FRUs from un-expanded location code.
     *
    ...
    types::ListOfPaths getFRUsByUnexpandedLocationCode(
        const std::string& i_unexpandedLocationCode, uint16_t i_nodeNumber = 0);
    ...
    /**
     * @brief Get un-expanded location code.
     *
     * An API to get un-expanded location code and node number from expanded
     * location code.
     *
     * @param[in] i_expandedLocationCode - Expanded location code.
     *
