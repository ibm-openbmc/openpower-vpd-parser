...
class Worker
{
  ...
  private:
    ...
    // Keeps track of active thread doing VPD collection.
    size_t activeCollectionThreadCount = 0;
     ...
     * collection. It just states, if the VPD collecton process is over or not.
     */
    bool isAllFruCollected = false;
};
} // namespace vpd
